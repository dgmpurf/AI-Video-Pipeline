# dreamina_cli_help_latest.md | 2026-07-01 help snapshot candidate

> Project: AI video production / Dreamina CLI execution layer Source
> Type: local CLI help snapshot candidate, not a rules explanation
> Intended action: replace current `sources/dreamina_cli_help_latest.md` after human review
