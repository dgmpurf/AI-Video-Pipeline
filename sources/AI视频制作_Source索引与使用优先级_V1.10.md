# AI视频制作_Source索引与使用优先级_V1.10

> 类型：Project Source index / replacement for V1.9
> 应用方式：建议由用户手动替换 V1.9。
> 状态：待用户手动应用；手动上传 / 同步后作为 official Source 使用。

## 1. Purpose

This V1.10 index preserves the V1.9 P0/P1/P2/P3 structure while adding the Dreamina CLI 2026-07-01 updates to the recommended Source reading order.
...
3. `dreamina_cli_help_latest.md` 20260701
...
1. Read this Source Index candidate after human application.
